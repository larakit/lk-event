...
class Event {
     ...
     * @param null  $subject
     */
    static function notify($event_name, $parameters = [], $subject = null) {
     ...
     * @return bool
     */
    static function notifyUntil($event_name, $parameters = [], $subject = null) {
        $event = new \sfEvent($subject, $event_name, $parameters);
     ...
     * @return mixed
     */
    static function filter($event_name, $default = null, $parameters = [], $subject = null) {
        $event = new \sfEvent($subject, $event_name, $parameters);
        self::dispatcher()
